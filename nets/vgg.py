...
class VGG(nn.Module):
    def __init__(self, features, num_classes=1000):
        ...
        self.avgpool = nn.AdaptiveAvgPool2d((7, 7))  # 主干层出来以后经过平均池化
...
def VGG16(pretrained, in_channels, **kwargs):
    ...
    if pretrained:
        ...
        state_dict = load_state_dict_from_url("file:///E:/unet-pytorch-main/unet-pytorch-main/nets/vgg16-397923af.pth",
